...
package com.liferay.object.admin.rest.resource.v1_0.factory;
...
public class ObjectEntryResourceFactoryImpl
	...
	private Object _invoke(
		...
		// FIXME how do we get objectDefinition?
		...
		ComponentInstance componentInstance =
			_objectEntryApplicationComponentFactory.newInstance(
				HashMapDictionaryBuilder.<String, Object>put(
					...
					"osgi.jaxrs.name", _objectDefinition.getName()
				).build()
			);

		ObjectEntryResource objectEntryResource =
			(ObjectEntryResource) componentInstance.getInstance();
	...
	private static class AcceptLanguageImpl implements AcceptLanguage {
		...
		public List<Locale> getLocales() {
			return Collections.singletonList(getPreferredLocale());
		}
