...
package com.liferay.dataset.custom.view.service.base;
...
/**
 * Provides the base implementation for the dataset custom view entry local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.liferay.dataset.custom.view.service.impl.DatasetCustomViewEntryLocalServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.liferay.dataset.custom.view.service.impl.DatasetCustomViewEntryLocalServiceImpl
 * @generated
 */
public abstract class DatasetCustomViewEntryLocalServiceBaseImpl
	extends BaseLocalServiceImpl
	implements AopService, DatasetCustomViewEntryLocalService,
			   IdentifiableOSGiService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>DatasetCustomViewEntryLocalService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>DatasetCustomViewEntryLocalServiceUtil</code>.
	 */
	...
	public DatasetCustomViewEntry addDatasetCustomViewEntry(
		...
		return datasetCustomViewEntryPersistence.update(datasetCustomViewEntry);
	}
	...
	public DatasetCustomViewEntry createDatasetCustomViewEntry(
		...
		return datasetCustomViewEntryPersistence.create(
	...
	public DatasetCustomViewEntry deleteDatasetCustomViewEntry(
		...
		return datasetCustomViewEntryPersistence.remove(
			datasetCustomViewEntryId);
	}
	...
	public DatasetCustomViewEntry deleteDatasetCustomViewEntry(
		...
		return datasetCustomViewEntryPersistence.remove(datasetCustomViewEntry);
	}

	@Override
	public <T> T dslQuery(DSLQuery dslQuery) {
		return datasetCustomViewEntryPersistence.dslQuery(dslQuery);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(
			DatasetCustomViewEntry.class, clazz.getClassLoader());
	}
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery) {
		return datasetCustomViewEntryPersistence.findWithDynamicQuery(
			dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery) {
		return datasetCustomViewEntryPersistence.countWithDynamicQuery(
			dynamicQuery);
	}
	...
	public DatasetCustomViewEntry fetchDatasetCustomViewEntry(
		...
		return datasetCustomViewEntryPersistence.fetchByPrimaryKey(
			datasetCustomViewEntryId);
	}
	...
	public DatasetCustomViewEntry fetchDatasetCustomViewEntryByUuidAndCompanyId(
		...
		return datasetCustomViewEntryPersistence.fetchByUuid_C_First(
			uuid, companyId, null);
	}
	...
	public DatasetCustomViewEntry getDatasetCustomViewEntry(
		...
		return datasetCustomViewEntryPersistence.findByPrimaryKey(
			datasetCustomViewEntryId);
	}
	...
	public ActionableDynamicQuery getActionableDynamicQuery() {
		...
		actionableDynamicQuery.setModelClass(DatasetCustomViewEntry.class);
			...
			new ActionableDynamicQuery.PerformActionMethod
				...
				public void performAction(
					...
					StagedModelDataHandlerUtil.exportStagedModel(
						portletDataContext, datasetCustomViewEntry);
				}
		...
		exportActionableDynamicQuery.setStagedModelType(
			new StagedModelType(
				PortalUtil.getClassNameId(
					DatasetCustomViewEntry.class.getName())));
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		...
		return datasetCustomViewEntryLocalService.deleteDatasetCustomViewEntry(
			(DatasetCustomViewEntry)persistedModel);
	}

	@Override
	public BasePersistence<DatasetCustomViewEntry> getBasePersistence() {
		return datasetCustomViewEntryPersistence;
	}
	...
	public DatasetCustomViewEntry getDatasetCustomViewEntryByUuidAndCompanyId(
		...
		return datasetCustomViewEntryPersistence.findByUuid_C_First(
			uuid, companyId, null);
	}
	...
	public List<DatasetCustomViewEntry> getDatasetCustomViewEntries(
		...
		return datasetCustomViewEntryPersistence.findAll(start, end);
	}
	...
	public int getDatasetCustomViewEntriesCount() {
		return datasetCustomViewEntryPersistence.countAll();
	}
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			DatasetCustomViewEntryLocalService.class,
	...
	public void setAopProxy(Object aopProxy) {
		datasetCustomViewEntryLocalService =
			(DatasetCustomViewEntryLocalService)aopProxy;

		_setLocalServiceUtilService(datasetCustomViewEntryLocalService);
	}
	...
	public String getOSGiServiceIdentifier() {
		return DatasetCustomViewEntryLocalService.class.getName();
	}
	...
	protected void runSQL(String sql) {
		try {
			DataSource dataSource =
				datasetCustomViewEntryPersistence.getDataSource();
	...
	private void _setLocalServiceUtilService(
		...
		try {
			Field field =
				DatasetCustomViewEntryLocalServiceUtil.class.getDeclaredField(
					"_service");

			field.setAccessible(true);

			field.set(null, datasetCustomViewEntryLocalService);
		}
	...
	@Reference
	protected DatasetCustomViewEntryPersistence
