...
/**
 * Provides the local service utility for DatasetCustomViewEntry. This utility wraps
 * <code>com.liferay.dataset.custom.view.service.impl.DatasetCustomViewEntryLocalServiceImpl</code> and
 ...
 * @generated
 */
public class DatasetCustomViewEntryLocalServiceUtil {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this class directly. Add custom service methods to <code>com.liferay.dataset.custom.view.service.impl.DatasetCustomViewEntryLocalServiceImpl</code> and rerun ServiceBuilder to regenerate this class.
	 */
	 ...
	 */
	public static DatasetCustomViewEntry addDatasetCustomViewEntry(
	 ...
	 */
	public static DatasetCustomViewEntry deleteDatasetCustomViewEntry(
		DatasetCustomViewEntry datasetCustomViewEntry) {

		return getService().deleteDatasetCustomViewEntry(
	 ...
	 */
	public static DatasetCustomViewEntry
		fetchDatasetCustomViewEntryByUuidAndCompanyId(
			String uuid, long companyId) {

		return getService().fetchDatasetCustomViewEntryByUuidAndCompanyId(
			uuid, companyId);
	}
	 ...
	 */
	public static List<DatasetCustomViewEntry> getDatasetCustomViewEntries(
		int start, int end) {

		return getService().getDatasetCustomViewEntries(start, end);
	}
	 ...
	 */
	public static int getDatasetCustomViewEntriesCount() {
		return getService().getDatasetCustomViewEntriesCount();
	}
	 ...
	 * @throws PortalException if a dataset custom view entry with the primary key could not be found
	 */
	public static DatasetCustomViewEntry getDatasetCustomViewEntry(
			long datasetCustomViewEntryId)
		throws PortalException {

		return getService().getDatasetCustomViewEntry(datasetCustomViewEntryId);
	}
	...
	public static DatasetCustomViewEntry
		...
		return getService().getDatasetCustomViewEntryByUuidAndCompanyId(
			uuid, companyId);
	}
	 ...
	 */
	public static DatasetCustomViewEntry updateDatasetCustomViewEntry(
		DatasetCustomViewEntry datasetCustomViewEntry) {

		return getService().updateDatasetCustomViewEntry(
			datasetCustomViewEntry);
	}

	public static DatasetCustomViewEntryLocalService getService() {
		return _service;
	}

	private static volatile DatasetCustomViewEntryLocalService _service;
