...
public class DataSetDisplayTag extends IncludeTag {
	...
	protected void setAttributes(HttpServletRequest httpServletRequest) {
		request.setAttribute(
			"dataset:display:actionParameterName", _actionParameterName);
		request.setAttribute(
			"dataset:display:activeViewSettingsJSON",
			_activeViewSettingsJSON);
		request.setAttribute("dataset:display:apiURL", _apiURL);
		request.setAttribute("dataset:display:appURL", _appURL);
		request.setAttribute(
			"dataset:display:bulkActionDropdownItems",
			_bulkActionDropdownItems);
		request.setAttribute(
			"dataset:display:clayDataSetDisplayViewsContext",
			_clayDataSetDisplayViewsContext);
		request.setAttribute(
			"dataset:display:clayPaginationEntries",
			_clayPaginationEntries);
		request.setAttribute(
			"dataset:display:creationMenu", _creationMenu);
		request.setAttribute(
			"dataset:display:dataProviderKey", _dataProviderKey);
		request.setAttribute("dataset:display:deltaParam", _deltaParam);
		request.setAttribute("dataset:display:formId", _formId);
		request.setAttribute("dataset:display:id", _id);
		request.setAttribute(
			"dataset:display:itemsPerPage", _itemsPerPage);
		request.setAttribute("dataset:display:module", _module);
		request.setAttribute("dataset:display:namespace", _namespace);
		request.setAttribute(
			"dataset:display:nestedItemsKey", _nestedItemsKey);
		request.setAttribute(
			"dataset:display:nestedItemsReferenceKey",
			_nestedItemsReferenceKey);
		request.setAttribute("dataset:display:pageNumber", _pageNumber);
		request.setAttribute(
			"dataset:display:paginationSelectedEntry",
			_paginationSelectedEntry);
		request.setAttribute("dataset:display:portletURL", _portletURL);
		request.setAttribute(
			"dataset:display:selectedItems", _selectedItems);
		request.setAttribute(
			"dataset:display:selectedItemsKey", _selectedItemsKey);
		request.setAttribute(
			"dataset:display:selectionType", _selectionType);
		request.setAttribute(
			"dataset:display:showManagementBar", _showManagementBar);
		request.setAttribute(
			"dataset:display:showPagination", _showPagination);
		request.setAttribute("dataset:display:showSearch", _showSearch);
		request.setAttribute("dataset:display:style", _style);
		request.setAttribute(
			"dataset:display:sortItemList", _sortItemList);
	}
	...
	private static final String _PAGE = "/display/page.jsp";
