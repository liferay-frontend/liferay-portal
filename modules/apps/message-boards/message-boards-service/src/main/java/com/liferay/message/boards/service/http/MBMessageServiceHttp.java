...
public class MBMessageServiceHttp {
	...
	public static java.util.List<com.liferay.message.boards.model.MBMessage>
		...
		try {
			MethodKey methodKey = new MethodKey(
				MBMessageServiceUtil.class, "getThreadMessages",
				_getThreadMessagesParameterTypes27);

			MethodHandler methodHandler = new MethodHandler(
				methodKey, threadId, queryDefinition);
	...
	public static int getThreadMessagesCount(
		...
		try {
			MethodKey methodKey = new MethodKey(
				...
				_getThreadMessagesCountParameterTypes28);
	...
	private static final Class<?>[] _getThreadMessagesParameterTypes27 =
		new Class[] {
			long.class, com.liferay.portal.kernel.dao.orm.QueryDefinition.class
		};
	private static final Class<?>[] _getThreadMessagesCountParameterTypes28 =
