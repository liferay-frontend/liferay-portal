...
declare const State: {
    ...
    _readSelector<T_1>(selector: {
        readonly deriveValue: (get: Getter) => T_1;
        readonly key: string;
        readonly "Liferay.State.SELECTOR": true;
    }, seen: Set<Selector<unknown>>): Immutable<T_1>;
    /**
     ...
     */
    selector<T_6>(key: string, deriveValue: (get: Getter) => T_6): {
        readonly "Liferay.State.SELECTOR": true;
     ...
     */
    subscribe<T_7 extends unknown>(atomOrSelector: {
