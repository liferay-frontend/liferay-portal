 ...
 */
export declare function copyNodeAttributes(source: HTMLElement, target: HTMLElement): void;
/**
 ...
 */
export declare function getNodeOffset(node: HTMLElement | null): {
    offsetLeft: number;
    offsetTop: number;
};
/**
 ...
 */
export declare function runStyle(style: Style, defaultFn?: DefaultFn, appendFn?: AppendFn): HTMLStyleElement | undefined;
/**
 ...
 *   into document.
 */
export declare function runStylesInElement(element: HTMLElement, defaultFn?: DefaultFn, appendFn?: AppendFn): void;
/**
