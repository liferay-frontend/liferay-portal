...
describe('Surface', () => {
	...
	describe('Surfaces', () => {
		...
		it('shows default surface child if screen id not found and hide when found', () => {
			var defaultChild = enterDocumentSurfaceElement(
				'surfaceId-default'
			)!;
...
function enterDocumentSurfaceElement(surfaceId: string, opt_content?: string) {
...
function exitDocumentSurfaceElement(surfaceId: string) {
