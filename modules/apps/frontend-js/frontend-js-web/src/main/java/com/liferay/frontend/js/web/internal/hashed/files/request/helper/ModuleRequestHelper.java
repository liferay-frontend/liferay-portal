 ...
 */
public class ModuleRequestHelper extends AbstractStaticFileRequestHelper {

	public ModuleRequestHelper(
		ConfigurationProvider configurationProvider,
		HashedFilesRegistry hashedFilesRegistry, Portal portal,
		ServiceTrackerMap<String, ServletContext> serviceTrackerMap) {

		super(
			ContentTypes.TEXT_JAVASCRIPT, ".js", hashedFilesRegistry,
			serviceTrackerMap);
