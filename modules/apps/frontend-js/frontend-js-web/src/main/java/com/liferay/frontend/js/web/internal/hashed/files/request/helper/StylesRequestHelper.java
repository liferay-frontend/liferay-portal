 ...
 */
public class StylesRequestHelper extends AbstractStaticFileRequestHelper {

	public StylesRequestHelper(
		ConfigurationProvider configurationProvider,
		HashedFilesRegistry hashedFilesRegistry, Portal portal,
		ServiceTrackerMap<String, ServletContext> serviceTrackerMap) {

		super(
			ContentTypes.TEXT_CSS, ".css", hashedFilesRegistry,
			serviceTrackerMap);
	...
	protected StaticFileCachingInfo getStaticFileCachingInfo(
		...
		try {
			...
			_log.error(
				"Unable to get CSS style sheets frontend caching " +
