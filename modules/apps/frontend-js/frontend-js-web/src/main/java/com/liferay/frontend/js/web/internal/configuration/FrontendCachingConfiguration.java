...
public interface FrontendCachingConfiguration {
	...
	@Meta.AD(
		deflt = "false",
		description = "disable-es-modules-infinite-caching-help",
		name = "disable-es-modules-infinite-caching", required = false
	)
	public boolean disableESModulesInfiniteCaching();
