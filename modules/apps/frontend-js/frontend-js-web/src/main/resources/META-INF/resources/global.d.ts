...
declare global {
	export interface Liferay {
		...
		readonly after: (eventName: string, callback: EventCallback) => void;
		readonly before: (eventName: string, callback: EventCallback) => void;
		readonly on: (eventName: string, callback: EventCallback) => void;
		readonly once: (eventName: string, callback: EventCallback) => void;
		readonly onceAfter: (
			eventName: string,
		...
		Language: {
			readonly available: {[languageId: string]: string};
			readonly direction: {[languageId: string]: 'ltr' | 'rtl' | null};
