...
function SaveSnapshotModalBody({
	...
	const handleValidatedLabelChange = onValidatedLabelChange;

	useEffect(() => {
		handleValidatedLabelChange(() => {
		...
		return () => {
			handleValidatedLabelChange(() => null);
		};
	}, [handleValidatedLabelChange, labelInputRef]);
...
const SnapshotsControls = () => {
	...
	const setValidatedLabel = (validatedLabel: () => null | string) => {
