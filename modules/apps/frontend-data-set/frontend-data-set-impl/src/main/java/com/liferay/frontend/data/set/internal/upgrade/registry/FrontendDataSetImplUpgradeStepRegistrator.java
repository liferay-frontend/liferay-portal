...
import com.liferay.frontend.data.set.internal.upgrade.v1_2_0.DataSetFragmentEditableValuesUpgradeProcess;
...
public class FrontendDataSetImplUpgradeStepRegistrator
	...
	public void register(Registry registry) {
		...
		registry.register(
			"1.1.0", "1.2.0",
			new DataSetFragmentEditableValuesUpgradeProcess());
	}
