...
/**
 * Provides the local service utility for FVSFrontendDataSet. This utility wraps
 * <code>com.liferay.frontend.view.state.service.impl.FVSFrontendDataSetLocalServiceImpl</code> and
 ...
 * @generated
 */
public class FVSFrontendDataSetLocalServiceUtil {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this class directly. Add custom service methods to <code>com.liferay.frontend.view.state.service.impl.FVSFrontendDataSetLocalServiceImpl</code> and rerun ServiceBuilder to regenerate this class.
	 */
	 ...
	 */
	public static FVSFrontendDataSet createFVSFrontendDataSet(
		long fvsFrontendDataSetId) {

		return getService().createFVSFrontendDataSet(fvsFrontendDataSetId);
	}
	 ...
	 */
	public static FVSFrontendDataSet deleteFVSFrontendDataSet(
		FVSFrontendDataSet fvsFrontendDataSet) {

		return getService().deleteFVSFrontendDataSet(fvsFrontendDataSet);
	}
	...
	public static FVSFrontendDataSet deleteFVSFrontendDataSet(
		...
		return getService().deleteFVSFrontendDataSet(fvsFrontendDataSetId);
	}
	...
	public static FVSFrontendDataSet fetchFVSFrontendDataSet(
		long fvsFrontendDataSetId) {

		return getService().fetchFVSFrontendDataSet(fvsFrontendDataSetId);
	}
	 ...
	 */
	public static FVSFrontendDataSet fetchFVSFrontendDataSetByUuidAndCompanyId(
		String uuid, long companyId) {

		return getService().fetchFVSFrontendDataSetByUuidAndCompanyId(
			uuid, companyId);
	}
	 ...
	 * @throws PortalException if a fvs frontend data set with the primary key could not be found
	 */
	public static FVSFrontendDataSet getFVSFrontendDataSet(
			long fvsFrontendDataSetId)
		throws PortalException {

		return getService().getFVSFrontendDataSet(fvsFrontendDataSetId);
	}
	 ...
	 */
	public static FVSFrontendDataSet getFVSFrontendDataSetByUuidAndCompanyId(
			String uuid, long companyId)
		throws PortalException {

		return getService().getFVSFrontendDataSetByUuidAndCompanyId(
			uuid, companyId);
	}
	 ...
	 */
	public static List<FVSFrontendDataSet> getFVSFrontendDataSets(
		int start, int end) {

		return getService().getFVSFrontendDataSets(start, end);
	}
	 ...
	 */
	public static int getFVSFrontendDataSetsCount() {
		return getService().getFVSFrontendDataSetsCount();
	}
	 ...
	 */
	public static FVSFrontendDataSet updateFVSFrontendDataSet(
		FVSFrontendDataSet fvsFrontendDataSet) {

		return getService().updateFVSFrontendDataSet(fvsFrontendDataSet);
	}

	public static FVSFrontendDataSetLocalService getService() {
		return _service;
	}

	private static volatile FVSFrontendDataSetLocalService _service;
