...
@Component(
	immediate = true,
	property = "clay.data.set.display.name=" + RemoteAppAdminConstants.REMOTE_CUSTOM_ELEMENT_ENTRY_DATA_SET_DISPLAY,
	service = ClayDataSetDisplayView.class
)
public class RemoteCustomElementEntryTableClayDataSetDisplayView
