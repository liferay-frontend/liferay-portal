...
public class RemoteCustomElementEntryClayDataSetActionProvider
	...
	public List<DropdownItem> getDropdownItems(
		...
		RemoteCustomElementClayDataSetEntry
			remoteCustomElementClayDataSetEntry =
				(RemoteCustomElementClayDataSetEntry)model;

		return DropdownItemListBuilder.add(
			dropdownItem -> _buildEditRemoteCustomElementEntryAction(
				dropdownItem, httpServletRequest,
				remoteCustomElementClayDataSetEntry)
		).add(
			dropdownItem -> _buildDeleteRemoteCustomElementEntryAction(
				dropdownItem, httpServletRequest,
				remoteCustomElementClayDataSetEntry)
		).build();
	}

	private void _buildDeleteRemoteCustomElementEntryAction(
		...
		dropdownItem.setHref(
			PortletURLBuilder.create(
				...
				"/remote_custom_element_admin" +
					"/delete_remote_custom_element_entry"
			).setParameter(
	...
	private void _buildEditRemoteCustomElementEntryAction(
		DropdownItem dropdownItem, HttpServletRequest httpServletRequest,
		RemoteCustomElementClayDataSetEntry
			remoteCustomElementClayDataSetEntry) {

		PortletURL editRemoteCustomElementEntryURL = PortletURLBuilder.create(
			_getRenderURL(httpServletRequest)
		).setMVCRenderCommandName(
			"/remote_custom_element_admin/edit_remote_custom_element_entry"
		).setParameter(
			"remoteCustomElementEntryId",
			remoteCustomElementClayDataSetEntry.getRemoteCustomElementEntryId()
		).build();
		...
		editRemoteCustomElementEntryURL.setParameter("redirect", currentURL);

		dropdownItem.setHref(editRemoteCustomElementEntryURL);
