...
public class RemoteCustomElementAdminPanelApp extends BasePanelApp {

	@Override
	public String getPortletId() {
		return RemoteAppAdminPortletKeys.REMOTE_CUSTOM_ELEMENT_ADMIN;
	}

	@Override
	@Reference(
		target = "(javax.portlet.name=" + RemoteAppAdminPortletKeys.REMOTE_CUSTOM_ELEMENT_ADMIN + ")",
		unbind = "-"
	)
