 ...
 */
public class RemoteCustomElementAdminDisplayContext {

	public RemoteCustomElementAdminDisplayContext(
				...
				dropdownItem.setHref(
					PortletURLBuilder.createRenderURL(
						...
						"/remote_custom_element_admin" +
							"/edit_remote_custom_element_entry"
					).setRedirect(
						_getRedirect()
					).build());

				dropdownItem.setLabel(_getLabel("new-remote-custom-element"));
			}
		).build();
	}
