...
@Component(
	immediate = true,
	property = {
		"com.liferay.portlet.css-class-wrapper=portlet-custom-element-portlet-admin",
		...
		"javax.portlet.display-name=Custom Element Portlets",
...
public class CustomElementPortletAdminPortlet extends MVCPortlet {
}