...
@Component(
	immediate = true,
	property = {
		"com.liferay.portlet.css-class-wrapper=portlet-remote-custom-element-admin",
		...
		"javax.portlet.display-name=Remote Custom Elements",
...
public class RemoteCustomElementAdminPortlet extends MVCPortlet {
}