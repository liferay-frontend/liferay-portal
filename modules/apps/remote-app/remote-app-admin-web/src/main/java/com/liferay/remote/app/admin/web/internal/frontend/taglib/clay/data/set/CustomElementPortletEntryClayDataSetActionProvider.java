...
@Component(
	immediate = true,
	property = "clay.data.provider.key=" + RemoteAppAdminConstants.CUSTOM_ELEMENT_PORTLET_ENTRY_DATA_SET_DISPLAY,
	service = ClayDataSetActionProvider.class
)
public class CustomElementPortletEntryClayDataSetActionProvider
	...
	public List<DropdownItem> getDropdownItems(
		...
		CustomElementPortletClayDataSetEntry
			customElementPortletClayDataSetEntry =
				(CustomElementPortletClayDataSetEntry)model;

		return DropdownItemListBuilder.add(
			dropdownItem -> _buildEditCustomElementPortletEntryAction(
				dropdownItem, httpServletRequest,
				customElementPortletClayDataSetEntry)
		).add(
			dropdownItem -> _buildDeleteCustomElementPortletEntryAction(
				dropdownItem, httpServletRequest,
				customElementPortletClayDataSetEntry)
		).build();
	}

	private void _buildDeleteCustomElementPortletEntryAction(
		...
		dropdownItem.setHref(
			PortletURLBuilder.create(
				...
				"/custom_element_portlet_admin" +
					"/delete_custom_element_portlet_entry"
			).setParameter(
	...
	private void _buildEditCustomElementPortletEntryAction(
		DropdownItem dropdownItem, HttpServletRequest httpServletRequest,
		CustomElementPortletClayDataSetEntry
			customElementPortletClayDataSetEntry) {

		PortletURL editCustomElementPortletEntryURL = PortletURLBuilder.create(
			_getRenderURL(httpServletRequest)
		).setMVCRenderCommandName(
			"/custom_element_portlet_admin/edit_custom_element_portlet_entry"
		).setParameter(
			"customElementPortletEntryId",
			customElementPortletClayDataSetEntry.
				getCustomElementPortletEntryId()
		...
		editCustomElementPortletEntryURL.setParameter("redirect", currentURL);

		dropdownItem.setHref(editCustomElementPortletEntryURL);
