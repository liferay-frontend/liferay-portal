...
@Component(
	immediate = true,
	property = "clay.data.set.display.name=" + RemoteAppAdminConstants.CUSTOM_ELEMENT_PORTLET_ENTRY_DATA_SET_DISPLAY,
	service = ClayDataSetDisplayView.class
)
public class CustomElementPortletEntryTableClayDataSetDisplayView
