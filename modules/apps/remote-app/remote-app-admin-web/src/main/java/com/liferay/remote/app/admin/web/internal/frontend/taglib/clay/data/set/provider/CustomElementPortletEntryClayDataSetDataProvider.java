...
import com.liferay.remote.app.admin.web.internal.frontend.taglib.clay.data.set.CustomElementPortletClayDataSetEntry;
...
public class CustomElementPortletEntryClayDataSetDataProvider
	implements ClayDataSetDataProvider<CustomElementPortletClayDataSetEntry> {

	@Override
	public List<CustomElementPortletClayDataSetEntry> getItems(
		...
		List<CustomElementPortletEntry> remoteCustomElementEntries =
		...
		Stream<CustomElementPortletEntry> stream =
			remoteCustomElementEntries.stream();

		return stream.map(
			remoteCustomElementEntry ->
				new CustomElementPortletClayDataSetEntry(
	...
	public int getItemsCount(
		...
		return _customElementPortletEntryLocalService.
			searchCustomElementPortletEntriesCount(
				themeDisplay.getCompanyId(), filter.getKeywords());
	}
