...
public class CustomElementPortletAdminPanelApp extends BasePanelApp {

	@Override
	public String getPortletId() {
		return RemoteAppAdminPortletKeys.CUSTOM_ELEMENT_PORTLET_ADMIN;
	}

	@Override
	@Reference(
		target = "(javax.portlet.name=" + RemoteAppAdminPortletKeys.CUSTOM_ELEMENT_PORTLET_ADMIN + ")",
		unbind = "-"
	)
