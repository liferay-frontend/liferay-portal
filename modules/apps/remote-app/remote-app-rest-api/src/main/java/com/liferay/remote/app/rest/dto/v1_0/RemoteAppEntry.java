...
package com.liferay.remote.app.rest.dto.v1_0;
 ...
 */
@Generated("")
@GraphQLName("RemoteAppEntry")
@JsonFilter("Liferay.Vulcan")
@XmlRootElement(name = "RemoteAppEntry")
public class RemoteAppEntry {

	public static RemoteAppEntry toDTO(String json) {
		return ObjectMapperUtil.readValue(RemoteAppEntry.class, json);
	}
	...
	@Schema(
		defaultValue = "com.liferay.remote.app.rest.dto.v1_0.RemoteAppEntry",
		name = "x-class-name"
	)
