create index IX_74E49D1D on CustomElementPortletEntry (uuid_[$COLUMN_LENGTH:75$], companyId);
...
create unique index IX_DAEE972A on RemoteCustomElementEntry (companyId, url[$COLUMN_LENGTH:1024$]);
