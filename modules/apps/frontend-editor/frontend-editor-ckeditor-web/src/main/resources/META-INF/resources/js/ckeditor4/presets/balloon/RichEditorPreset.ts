...
const RichEditorPreset = {
	balloonEditorEnabled: true,
	extraAllowedContent: '*',
	extraPlugins:
		'itemselector,stylescombo,ballooneditor,videoembed,insertbutton,aicreator',
	...
	toolbarText:
		'Undo,Redo,Styles,Bold,Italic,Underline,BulletedList,NumberedList,TextLink,Source,Expand,AICreator',
	toolbarVideo: 'VideoAlignLeft,VideoAlignCenter,VideoAlignRight',
};

export default RichEditorPreset;
