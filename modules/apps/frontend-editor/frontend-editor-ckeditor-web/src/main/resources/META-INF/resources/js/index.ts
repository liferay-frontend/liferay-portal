...
export {default as CKEditor5BasicPreset} from './ckeditor5/presets/CKEditor5BasicPreset';
export {default as CKEditor5AdvancedPreset} from './ckeditor5/presets/CKEditor5AdvancedPreset';
