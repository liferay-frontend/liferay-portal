...
public class MFAFIDO2CredentialEntryModelImpl
	...
	public static final String TABLE_SQL_CREATE =
		"create table MFAFIDO2CredentialEntry (mvccVersion LONG default 0 not null,mfaFIDO2CredentialEntryId LONG not null primary key,companyId LONG,userId LONG,userName VARCHAR(75) null,createDate DATE null,modifiedDate DATE null,credentialId VARCHAR(128) null,credentialType INTEGER,publicKeyCose VARCHAR(128) null,signatureCount LONG,failedAttempts INTEGER,lastFailDate DATE null,lastFailIP VARCHAR(75) null,lastSuccessDate DATE null,lastSuccessIP VARCHAR(75) null)";
	...
	static {
		...
		columnBitmasks.put("lastFailDate", 4096L);

		columnBitmasks.put("lastFailIP", 8192L);

		columnBitmasks.put("lastSuccessDate", 16384L);

		columnBitmasks.put("lastSuccessIP", 32768L);
