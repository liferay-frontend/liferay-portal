...
public class MFAFIDO2CredentialEntryLocalServiceUtil {
	...
	public static
		...
		return getService().fetchMFAFIDO2CredentialEntryByCredentialId(
			credentialId);
	}
	...
	public static
		...
		return getService().fetchMFAFIDO2CredentialEntryByUserId(userId);
	}
	...
	public static
		...
		return getService().updateAttempts(userId, ip, signatureCount);
	}
